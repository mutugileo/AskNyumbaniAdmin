...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-[0_12px_24px_-14px_hsl(var(--primary)/0.95)] hover:-translate-y-0.5 hover:brightness-[1.03]",
        destructive:
          "bg-destructive text-destructive-foreground shadow-[0_12px_24px_-14px_hsl(var(--destructive)/0.95)] hover:-translate-y-0.5 hover:bg-destructive/90",
        outline:
          "border border-input/80 bg-background/80 hover:border-primary/40 hover:bg-secondary/80 hover:text-foreground",
        secondary:
